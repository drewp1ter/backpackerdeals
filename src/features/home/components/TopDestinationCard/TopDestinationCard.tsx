...
export const TopDestinationCard: React.FC<IProps> = ({ title, country, variant, size, gradDeg = 0, className }) => {
  ...
  return (
    <div className={rootClass} data-size={size}>
      ...
      <img
        srcSet={srcSet}
        sizes="(max-width: 320px) 100px, (max-width: 320px) 144px, (max-width: 1024px) 312px, (max-width: 1024px) 152px, (max-width: 1280px) 345px, (max-width: 1280px) 168px, 496px, 240px"
